...
/**
* Old Way or Say Paid Way
*/
// var mySplitText = new SplitText("#quote", {type:"chars,words, lines"});
// // 	console.log(mySplitText)
// // TweenLite.set(".text", {perspective:500, perspectiveOrigin:"50% 50%", transformStyle:"preserve-3d"});

// var numChars = mySplitText.chars.length;
// action = new TimelineMax({repeat:2220})
//   .staggerFrom(mySplitText.chars, 2, {y:17.6, ease:Elastic.easeInOut}, 0.02, 1)
//   .to(mySplitText.chars, 2, {y:0, ease:Elastic.easeInOut}, "+=1")

/**
* New Way or Say FREE WAY :P
*/
